...
export function buildReportHtml(report: FinancialReport, { labels, locale }: ReportExportOptions) {
  ...
  return `<!doctype html><html><head><meta charset="utf-8"><style>
    ...
    .panel { border: 1px solid #D8EAF0; border-radius: 12px; padding: 5mm; margin-bottom: 6mm; break-inside: avoid; } .note { background: #EDF8FA; border-left: 4px solid #5DD6E5; border-radius: 7px; color: #496C7A; padding: 4mm; }
