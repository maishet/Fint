...
import type {
  ...
  CreateAccountInput,
  CreateAccountResult,
  EnableAccountBalanceInput,
  EnableAccountBalanceResult,
  DisableAccountBalanceResult,
  CreateCategoryInput,
...
export const financeApi = {
  ...
  updateCategory: (id: string, input: UpdateCategoryInput) => apiRequest<CategoryMutationResult>(`/api/categories/${id}`, { method: 'PATCH', body: JSON.stringify(input) }),
  deleteCategory: (id: string) => apiRequest<CategoryMutationResult>(`/api/categories/${id}`, { method: 'DELETE' }),
  ...
  updatePaymentRule: (id: string, input: UpdatePaymentRuleInput) => apiRequest<{ id: string }>(`/api/payment-rules/${id}`, { method: 'PATCH', body: JSON.stringify(input) }),
  ...
  deletePushInstallation: (installationId: string) => apiRequest<{ id: string | null }>(`/api/push/installations/${installationId}`, { method: 'DELETE' }),
  connectGmailNative: (serverAuthCode: string) => apiRequest<GmailNativeOAuthResult>('/api/integrations/gmail/oauth/native-callback', { method: 'POST', body: JSON.stringify({ serverAuthCode }) }),
