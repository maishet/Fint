  ...
  es: {
    translation: {
      ...
      capture: {
        ...
        resultTitle: "Importación completa",
        summaryWorking: "Leyendo tus constancias…",
        addMore: "Agregar más",
        created: "Creados",
        duplicates: "Duplicados omitidos",
        ...
        failed: "Con errores",
        rowQueued: "En cola",
        rotating1: "Analizando la imagen…",
        rotating2: "Buscando el monto…",
        rotating3: "Identificando el banco…",
        rotating4: "Verificando la fecha…",
        rotating5: "Casi listo…",
        rowDuplicate: "Ya existe, se omitió",
        rowUnrecognized: "No se reconoció como constancia",
        whoDidThis: "¿Quién hizo esta operación?",
        iWasPaid: "Me pagaron",
        iPaid: "Yo pagué",
        deleteRow: "Eliminar",
        deleteRowTitle: "¿Quitar esta imagen?",
        deleteRowDescription: "Se quitará de esta lista. No se guardó nada de ella.",
        deleteRowDescriptionCreated: "Se quitará de esta lista y se descartará el pendiente que ya se había guardado.",
        deleteRowConfirm: "Quitar",
        deletingRow: "Quitando…",
        save: "Guardar",
        done: "Listo",
        ...
        errors: {
          ...
          quotaExhausted: "Se agotó la cuota diaria de extracción. Intenta más tarde.",
          unauthorized: "Tu sesión expiró. Vuelve a iniciar sesión.",
          visionUnavailable: "El servicio de extracción no está disponible ahora.",
          unknown: "No pudimos procesar esta imagen.",
          deleteFailed: "No pudimos quitar esta imagen.",
        },
        pipelineErrors: {
          uri_not_allowed: "Origen de imagen no permitido.",
          file_too_large: "La imagen es demasiado pesada.",
          unrecognized_format: "El archivo no es una imagen reconocida.",
          decompression_bomb: "La imagen tiene dimensiones no seguras.",
          processing_timeout: "El procesamiento de la imagen tardó demasiado.",
          processing_failed: "No se pudo procesar la imagen.",
        },
      },
      ...
      accounts: {
        ...
        emailKeywordsLabel: "Palabras clave de correo",
        emailKeywordsPlaceholder: "Ej.: BCP",
        emailKeywordsHint:
          "Opcional: palabras que aparecen en tus correos del banco (ej. “BCP”) para reconocer esta cuenta automáticamente.",
        emailKeywordsRemoveAccessibility: "Quitar {{keyword}}",
        emailKeywordsAddLabel: "Agregar",
  ...
  en: {
    translation: {
      ...
      capture: {
        ...
        resultTitle: "Import complete",
        summaryWorking: "Reading your receipts…",
        addMore: "Add more",
        created: "Created",
        duplicates: "Duplicates skipped",
        ...
        failed: "Errors",
        rowQueued: "Queued",
        rotating1: "Analyzing the image…",
        rotating2: "Looking for the amount…",
        rotating3: "Identifying the bank…",
        rotating4: "Checking the date…",
        rotating5: "Almost there…",
        rowDuplicate: "Already exists, skipped",
        rowUnrecognized: "Not recognized as a receipt",
        whoDidThis: "Who made this operation?",
        iWasPaid: "I was paid",
        iPaid: "I paid",
        deleteRow: "Delete",
        deleteRowTitle: "Remove this image?",
        deleteRowDescription: "It will be removed from this list. Nothing from it was saved.",
        deleteRowDescriptionCreated: "It will be removed from this list and the pending movement already saved from it will be discarded.",
        deleteRowConfirm: "Remove",
        ...
        errors: {
          ...
          quotaExhausted: "Daily extraction quota reached. Try again later.",
          unauthorized: "Your session expired. Sign in again.",
          visionUnavailable: "The extraction service is unavailable right now.",
          unknown: "We couldn't process this image.",
          deleteFailed: "We couldn't remove this image.",
        },
        pipelineErrors: {
          uri_not_allowed: "Image source not allowed.",
          file_too_large: "The image is too large.",
          unrecognized_format: "The file is not a recognized image.",
          decompression_bomb: "The image has unsafe dimensions.",
          processing_timeout: "Processing the image took too long.",
          processing_failed: "Could not process the image.",
        },
      },
      ...
      accounts: {
        ...
        emailKeywordsLabel: "Email keywords",
        emailKeywordsPlaceholder: "E.g. BCP",
        emailKeywordsHint:
          "Optional: words that appear in your bank emails (e.g. \"BCP\") to automatically recognize this account.",
        emailKeywordsRemoveAccessibility: "Remove {{keyword}}",
        emailKeywordsAddLabel: "Add",
...
i18n.addResourceBundle(
  ...
  "translation",
  {
    ...
    settings: {
      ...
      locationCapture: "Ubicación en movimientos",
      locationCaptureDetail: "Guardar dónde ocurre cada movimiento nuevo",
    ...
    location: {
      ...
      autoBannerBody: "Se agrega sola la próxima vez, en segundo plano. Puedes quitarla cuando quieras.",
      autoBannerConfirm: "Activar ubicación",
      dragHint: "Arrastra o pellizca para ajustar",
      searchPlaceholder: "Buscar un lugar",
      searchAction: "Buscar",
      searchingSuggestions: "Buscando lugares…",
      searchNotFound: "No encontramos ese lugar. Prueba con otro nombre.",
      editTitle: "Editar ubicación",
      useCurrent: "Usar mi ubicación",
      noneYet: "Busca un lugar o usa tu ubicación actual",
    ...
    payments: {
      ...
      autoPayLabel: "Se paga solo desde mi banco",
      autoPayHint:
        "Fint registrará el gasto automáticamente en la cuenta que elijas. Tu banco es quien cobra.",
      autoPayAccount: "Cuenta de cargo",
      autoPayAccountRequired: "Elige la cuenta desde la que se registrará el pago.",
      autoPayNoAccounts:
        "No tienes cuentas en {{currency}} para registrar este pago.",
      autoPayCreateAccount: "Crear cuenta",
      autoPayBadge: "Automático",
...
i18n.addResourceBundle(
  ...
  "translation",
  {
    ...
    settings: {
      ...
      locationCapture: "Location on movements",
      locationCaptureDetail: "Save where each new movement happens",
    ...
    location: {
      ...
      autoBannerBody: "It's added on its own next time, in the background. You can remove it anytime.",
      autoBannerConfirm: "Turn on location",
      dragHint: "Drag or pinch to adjust",
      searchPlaceholder: "Search a place",
      searchAction: "Search",
      searchingSuggestions: "Searching places…",
      searchNotFound: "We couldn't find that place. Try another name.",
      editTitle: "Edit location",
      useCurrent: "Use my location",
      noneYet: "Search a place or use your current location",
      tapToAdd: "Tap to add",
    },
    movementUx: {
    ...
    payments: {
      ...
      autoPayLabel: "My bank pays this on its own",
      autoPayHint:
        "Fint will record the expense automatically in the account you pick. Your bank is the one charging you.",
      autoPayAccount: "Charge account",
      autoPayAccountRequired: "Pick the account the payment will be recorded from.",
      autoPayNoAccounts: "You have no {{currency}} accounts to record this payment.",
      autoPayCreateAccount: "Create account",
      autoPayBadge: "Automatic",
      frequency: "Frequency",
...
i18n.addResourceBundle(
  ...
  "translation",
  {
    ...
    settings: {
      ...
      locationCapture: "Localização nos movimentos",
      locationCaptureDetail: "Salvar onde acontece cada movimento novo",
    ...
    location: {
      ...
      autoBannerBody: "Ela é adicionada sozinha na próxima vez, em segundo plano. Você pode removê-la quando quiser.",
      autoBannerConfirm: "Ativar localização",
      dragHint: "Arraste ou belisque para ajustar",
      searchPlaceholder: "Buscar um lugar",
      searchAction: "Buscar",
      searchingSuggestions: "Buscando lugares…",
      searchNotFound: "Não encontramos esse lugar. Tente outro nome.",
      editTitle: "Editar localização",
      useCurrent: "Usar minha localização",
      noneYet: "Busque um lugar ou use sua localização atual",
    ...
    payments: {
      ...
      autoPayLabel: "É pago sozinho pelo meu banco",
      autoPayHint:
        "O Fint registrará a despesa automaticamente na conta que você escolher. Quem cobra é o seu banco.",
      autoPayAccount: "Conta de débito",
      autoPayAccountRequired: "Escolha a conta da qual o pagamento será registrado.",
      autoPayNoAccounts:
        "Você não tem contas em {{currency}} para registrar este pagamento.",
      autoPayCreateAccount: "Criar conta",
      autoPayBadge: "Automático",
