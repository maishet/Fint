...
if (occurrences !== 2) {
  throw new Error(`Unexpected expo-router linking source shape: found ${occurrences} callbacks`)
}

const patched = source.replaceAll(directCall, deferredCall).replace(
